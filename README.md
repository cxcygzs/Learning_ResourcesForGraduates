...
2. 组会进行阅读汇报，并让导师给出建议，**开始撰写综述（提前预选投稿杂志)**。引用的文献最好是五年内的，格式一定按照目标杂志要求（使用Mendeley、ENDNOTE或者NOTEXPRESS等软件进行文献管理)。
3. **英语六级460分以上！考博的必要条件之一！**
#### 研一第二学期
1. 一学期的阅读及写作，以及同导师的多次交流，可以很明确自己的选题方向，准备撰写开题报告，撰写开题报告时，一定要严谨严谨再严谨！这关系到你的毕业！
2. **第二学期结束前，综述文章一定要投出去！** 一定要仔细，细节决定成败，低级错误不要犯。
#### 研二第一学期
...
2. [A review of knowledge graph application scenarios in cyber security.pdf](https://github.com/cxcygzs/Learning_ResourcesForGraduates/files/10314038/A.review.of.knowledge.graph.application.scenarios.in.cyber.security1.pdf)
