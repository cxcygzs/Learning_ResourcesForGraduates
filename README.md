...
---
### 知识图谱与大语言模型
1. [Ask ChatGPT and Get an Annotated Response](https://demos.isl.ics.forth.gr/GPToLODS/demo#main)[Using Multiple RDF Knowledge Graphs for Enriching ChatGPT Responses](https://github.com/cxcygzs/Learning_ResourcesForGraduates/files/11496662/Using.Multiple.RDF.Knowledge.Graphs.for.Enriching.ChatGPT.Responses.pdf)
